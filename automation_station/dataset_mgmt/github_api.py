...
class GitHubPuller:
    ...
    def get_sql_files_in_org_shell_script(self, cmx_org_schema_name):
        ...
        which includes OneViews, so getting all names from the shell script should provide
        us with all possible OneViews for a specific organization.
    ...
    def get_sql_files_specific_to_client(self, cmx_org_schema_name, cmx_client_schema_name):
        """Gets a list of SQL files that exist in the client-specific folder.
