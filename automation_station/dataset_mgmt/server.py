...
#     org_shell_oneview_list = ghpuller.get_sql_files_in_org_shell_script(cmx_org_schema_name=org_dict["schema name"])
#     client_oneview_list = ghpuller.get_sql_files_specific_to_client(cmx_org_schema_name=org_dict["schema name"],
